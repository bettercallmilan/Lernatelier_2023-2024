...
- [x] An Modul 319 weiterarbeiten und E-Portfolio weiterschreiben.


## Reflexion

In diesem Modul konnte ich meine Fähigkeiten in C# verbessern und Visual Studio Code besser kennenlernen. Bei den einzelnen Projekten konnte ich die einzelnen Funktionen wie z.B. if else, switch case, try catch usw. besser verstehen und vertiefen. Manchmal habe ich jedoch bei einzelnen Funktionen Probleme, da ich weiss wie sie funktionieren aber ich weiss nicht genau wie ich sie schreiben soll. Deswegen habe ich mit einer Dokumentation aller Funktionen angefangen und kann diese bei solchen Fällen gebrauchen. Ich habe auch an den Modulen gearbeitet, da wir in der Kanti zurzeit Prüfungen haben, und ich möchte nicht, dass sich die Aufträge in einem Modul aufstapeln und dass ich dann an einem Tag vieles machen muss, sondern es aufteile. (118 W)
Verbesserungsvorschlag: Jedes mal, wenn ich merke, dass ich eine Funktion nicht so gut verstanden habe, repetiere ich sie und schreibe einen Programm mit dieser Funktion, damit ich sie anwenden kann und verstehen kann wie sie genau aufgebaut ist.
